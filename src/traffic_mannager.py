...
def update_context_on_roads(graph, contextual, step):
    ...
    for road in graph.nodes():
        ...
        # Trade-off
        step_time = step // 35
        weight, metrics = contextual.trade_off(traffic, start, end, step_time, context_weight={'traffic': 1, 'crimes': 0, 'crashes': 0})
        #weight, metrics = contextual.trade_off(traffic, start, end, step_time, context_weight={'traffic': 0, 'crimes': 1, 'crashes': 0})
        #weight, metrics = contextual.trade_off(traffic, start, end, step_time, context_weight={'traffic': 0, 'crimes': 0, 'crashes': 1})
